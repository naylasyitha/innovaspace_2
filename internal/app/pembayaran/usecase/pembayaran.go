...
// 	CreatePembayaran(userId uuid.UUID, total int, tipeBayar string) (*dto.PaymentResponse, error)
...
// func (u *PembayaranUsecase) CreatePembayaran(userId uuid.UUID, total int, tipeBayar string) (*dto.PaymentResponse, error) {

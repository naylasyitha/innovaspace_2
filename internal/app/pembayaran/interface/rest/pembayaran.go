...
// func NewPembayaranHandler(routerGroup fiber.Router, pembayaranUsecase usecase.PembayaranUsecase) {
...
// 	userId, err := ctx.Locals("userId").(uuid.UUID)
// 	if err != nil{
// 		return ctx.Status(fiber.StatusBadRequest).JSON(fiber.Map{
...
// 	pembayaran, err := h.PembayaranUsecase.CreatePembayaran(userId, request.Total, request.TipeBayar)
// 	if err != nil {
